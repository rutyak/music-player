...
const SortableItem = ({ id, index, song, setSongId, songId }) => {
  ...
  return (
    ...
    >
      <td className="py-2 pr-2 pl-20 text-white">{isSelected? <img src={musicIcon} alt="music-icon" className="w-6"/> :index + 1}</td>
      ...
      <td className="py-2 pl-4 pr-20 text-white text-right">{song.album}</td>
    </tr>
  );
};
